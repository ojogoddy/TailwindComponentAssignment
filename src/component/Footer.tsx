...
<footer className="bg-white dark:bg-gray-900">
    <div className="container px-6 py-12 mx-auto">
        <div className="text-center">
            ...
            <p className="max-w-md mx-auto mt-2 text-gray-500 dark:text-gray-400">Join over 4,000+ startups already shopping with OjogoddyKit.</p>

            <div className="flex flex-col mt-6 sm:flex-row sm:items-center sm:justify-center">
                <button className="w-full px-9 py-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-700 rounded-md sm:mx-2 sm:order-2 sm:w-auto hover:bg-indigo-600 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">Buy Now</button>
                <span>
        ...
        <div className="flex flex-col items-center justify-between sm:flex-row">
            ...
            <h1 className="text-white text-2xl font-bold h-7">OjoGoddyKit</h1>
