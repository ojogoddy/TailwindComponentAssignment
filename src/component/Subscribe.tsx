...
const Subscribe = () => {
  return (
    <div className='bg-gray-100 py-10'>
        {/* <!-- component --> */}
<div className="flex flex-col mx-auto max-w-4xl md:h-56 bg-white rounded-lg shadow-lg overflow-hidden md:flex-row ">
        <div className="md:flex items-center justify-center md:w-1/2 md:bg-gray-700">
            <div className="py-6 px-8 md:py-0">
                ...
                <p className="mt-2 text-gray-600 md:text-gray-400">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consectetur obcaecati odio</p>
            </div>
        </div>
